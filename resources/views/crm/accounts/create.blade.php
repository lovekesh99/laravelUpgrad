...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="overview-wrap">
                        <h2 class="title-1">Create Account</h2><br/><br/>
            ...
            @endif
            <form action="{{route('accounts.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">    
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="account_name" class=" form-control-label">Accoun Name</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="account_name" placeholder="Enter Account Name" class="form-control">
                                        @error('account_name')
                                        <small class="help-block form-text text-danger">{{$message}}</small> 
                                        @enderror
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="account_site" name="account_site" placeholder="Enter Account Site " class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="account_number" name="account_number" placeholder="Enter Account Number " class="form-control">
                                        <small class="help-block form-text"></small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">                  
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="employees" name="employees" placeholder="Enter Employees" class="form-control">
                                                  @error('employees')
                                                    <small class="help-block form-text text-danger">{{$message}}</small>
                                                  @enderror
                                                </div>
